...
I think the data is skewed to the left one standard deviation from the mean because the tail is longer on the left side of the graph toward the lower values of the data set. 
