...
### Task 3: Calcuate the mean and standard deviation of the danceability scores
...
spotify_songs |>
  ggplot() +
  geom_histogram(aes(x = danceability), binwidth = 0.06)
```
...
The distribution of the danceability scores is skewed to the left. Most of the songs have danceability scores between about 0.5 and 0.85, with the largest concentration around 0.7 to 0.8. This distribution shows us that most of the songs in this dataset have relatively high dancebility scores. I would not say that this is a normal distribution of data because of the long tail to the left, making the histogram not symmetrical like a normal graph would.
